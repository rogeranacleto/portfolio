...
export function About(){
    return (
      <div
        className="min-h-screen flex justify-center max-w-screen w-full flex-col mb-75"
        id="about"
      >
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center justify-center flex-col mb-8 pl-10 pr-10">
            <p
              className="text-white mt-4 text-6xl font-medium max-w-4xl text-center mb-4"
              data-aos="fade-left"
              data-aos-duration="2800"
            >
        ...
        <div className="flex items-center justify-center gap-10 mt-15 flex-wrap m-8 flex-col">
          <div
            className="max-w-250 w-full bg-white rounded-2xl p-10"
            data-aos="fade-right"
          ...
          >
            ...
            <p className="text-black mt-7 text-lg text-left">
              ...
              (ADS). Atuo no desenvolvimento de interfaces web e procuro aliar
              boas práticas, acessibilidade e uma experiência de uso eficiente.
            </p>
            ...
            <div className="flex items-center justify-center flex-col mt-10">
              <a
                href="/curriculo-rogeranacleto.pdf"
                target="_blank"
                className="bg-linear-to-r from-[#1d1c1c] via-[#4b4a4a6b] to-[#c2bebe13] text-white font-semibold px-6 py-3 rounded-xl shadow-md transition-all hover:scale-110 duration-300 cursor-pointer"
              >
                Download Currículo
              </a>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      <p className="text-[#c2bebee3] text-lg">
                        ...
                        integrações com
                        <span className="text-white fon-bold">
                          {" "}
                          APIs RESTful
                        </span>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      <p className="text-[#c2bebee3] text-lg">
                        ...
                        e{" "}
                        <span className="text-white font-bold">dinâmicas</span>,
              ...
              <div data-aos="fade-left" data-aos-duration="2200">
                <div className="max-w-120 w-full min-h-100 backdrop-blur-xs border border-solid border-[#c2bebe15] rounded-2xl p-10 hover:scale-105 duration-300 ease-in-out">
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      <p className="text-[#c2bebee3] text-lg">
                        Procuro seguir boas práticas de usabilidade, performance
                        e organização do código, para que os projetos sejam mais
